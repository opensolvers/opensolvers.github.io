...
IME is **~6–7×** RVV int8 and crests near **45 GOP/s** at 768³ — same conclusion as the [RV2](RV2.html#ime-integer-matrix-extension) (~42 GOP/s peak there). Source: [benchmarks/ime](https://github.com/opensolvers/benchmarks/tree/main/ime).

**Usage:** same as RV2 — **use IME**, leave **TCM off** for real LLM weights ([how to use IME / TCM](RV2.html#how-to-use-ime-and-when-not-to-use-tcm)).
