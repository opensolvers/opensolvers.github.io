---
title: Sponsors
description: Support OpenSolvers — fund RISC-V boards, CI, and open scientific software / AI inference benchmarks across more platforms.
...
| ------- | ---- | ------------ |
| **$5** | Supporter | Sponsor badge on your GitHub profile |
| **$25** | Backer | Badge + name listed below + priority issue triage on [benchmarks](https://github.com/opensolvers/benchmarks) |
| **$100** | Sponsor | Logo + link below; listed in the benchmarks README |
| **$250** | Gold | Homepage logo; mention in relevant [YouTube](https://www.youtube.com/@opensolvers) descriptions; direct contact on what we benchmark next |

One-time options: **$10** thank-you tip, **$100** one-time sponsor (name or logo listed here for three months).
