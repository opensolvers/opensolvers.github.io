...
| **Custom** | Custom ISA extensions beyond standard RVV | X60 **IME** / **XsmtVdot** (`smt.vmadot`) int8 on [RV2](boards/RV2.html) / [F3](boards/F3.html) — **use IME**; **TCM off** for LLM e2e; [ONNX](apps/onnx.html) / [llama.cpp](apps/llamacpp.html) |
...
- **[Orange Pi RV2](boards/RV2.html)** — SpaceMiT K1, 8× X60 (RVV + IME). Fixed OpenBLAS: HPL **FAILED (`nan`) → 10.53 GFLOP/s**; [QE](apps/qe.html) high-mem **1.46×**; [llama.cpp](apps/llamacpp.html) Q8_0 hybrid tg **6.68**; **IME on / TCM off** for LLM; GROMACS Force **3.31×**; **BXE-2-32 GPGPU closed**.
